                ...
                <div class="col-lg-9 col-md-8 mainpage">
                    <div class="account_heading">
                        ...
                        <div class="account_hd_right">
                            <a href="http://127.0.0.1:8000/logout" class="main_lg_btn">Logout</a>
                        </div>
                    </div>
                    ...
                    <div class="account_tabs">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="http://127.0.0.1:8000/dashboard">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://127.0.0.1:8000/add_project">Add New Project</a>
                            </li>
                            <li class="nav-item">
